...
- [SIL.BuildTasks.Tests.Helper] Replaced the native ForceCrash.dll test helper with a managed equivalent, removing the need for a Visual C++ compiler to build the solution on Windows.
